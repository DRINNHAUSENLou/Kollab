  ...
  <div class="flex flex-1">
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-12">
      <div class="bg-gray-800 bg-opacity-90 rounded-xl w-full max-w-3xl mx-auto p-8">
        <h1 class="text-3xl font-bold text-purple-300 mb-6 text-center">CGU — Kollab</h1>
        <div class="space-y-4 text-gray-200">
          <p class="text-base text-gray-300">
            Voici un exemple de Conditions Générales d'Utilisation pour Kollab. <span class="text-purple-200">Informations fictives</span> à titre illustratif seulement.
          </p>
          <h2 class="text-xl text-purple-400 font-bold mt-6">1. Utilisation du service</h2>
          <p class="text-gray-400">
            Vous acceptez d'utiliser Kollab en respectant toutes les lois imaginaires en vigueur dans l'univers parallèle de la démo.
          </p>
          <h2 class="text-xl text-purple-400 font-bold mt-6">2. Données et compte</h2>
          <p class="text-gray-400">
            Vos données factices sont stockées dans une base de données fictive et ne seront jamais utilisées ni partagées réellement.
          </p>
          <h2 class="text-xl text-purple-400 font-bold mt-6">3. Modifications</h2>
          <p class="text-gray-400">
            Les présentes CGU ne seront jamais mises à jour, sauf dans vos rêves les plus fous.
          </p>
          <h2 class="text-xl text-purple-400 font-bold mt-6">4. Contact imaginaire</h2>
          <p class="text-gray-400">
            Une question ? Envoyez un pigeon voyageur ou un email à <span class="underline text-purple-300">cgu@kollab-fake.fr</span>.
          </p>
        </div>
      </div>
    </main>
